%%   Distance Regularized Level Set Evolution Segmentation Function (1 matrix detector)
...
%-------------------------------------------------------------------------%
%-------------------------------------------------------------------------%
function DRLSE_segment_1m(image, timestep, mu, lambda, alpha, epsilon, maxiter, sigma, state, m1, n1)
%% Read the inputs
if ischar(image) == 1
    image = imread(image);
